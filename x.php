<html dir="ltr" lang="en"><head>
  ...
  <title>personal.graceland.edu</title>
...
<body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong jscontent="hostName" jstcache="22">personal.graceland.edu</strong> is currently unable to handle this request.</p>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong jscontent="hostName" jstcache="22">personal.graceland.edu</strong> is currently unable to handle this request.</div>
  </div>
...
class LoadTimeData {
  ...
  console.warn('crbug/1173575, non-JS module files deprecated.');</script><script jstcache="0">const pageData = {"details":"Details","errorCode":"HTTP ERROR 500","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"personal.graceland.edu","msg":"This page isn’t working"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadUrl":"http://personal.graceland.edu/~zliu/PHP/PHP/CH4/php_apps/uploads/nob.jpg.php"},"suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"failedUrl":"http://personal.graceland.edu/~zliu/PHP/PHP/CH4/php_apps/uploads/nob.jpg.php","hostName":"personal.graceland.edu","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong> is currently unable to handle this request."},"textdirection":"ltr","title":"personal.graceland.edu"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>
